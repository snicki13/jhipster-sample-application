...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof eu.shapedem.hipster.service.EmailAlreadyUsedException ||
            ex instanceof eu.shapedem.hipster.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof eu.shapedem.hipster.service.InvalidPasswordException
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "eu.shapedem.hipster");
    }
}
